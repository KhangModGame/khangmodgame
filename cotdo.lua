do
    ...
    _G.Color = Color3.fromRGB(3, 119, 252)
    ...
    Title.Text = "Khang Mod Game ".."<font color='rgb(3, 119, 252)'>Version 1.7 </font>".."- "..game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name
    Title.RichText = true;
    ...
    Text2.Text = "Subscribe Ytb Khang Mod Game"
    ...
    Textbtn2.MouseButton1Click:Connect(function()
      ...
      setclipboard("https://www.youtube.com/@KhangModGame")
      end)
